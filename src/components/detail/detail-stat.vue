  ...
  <div class="detail-stat">
    ...
    <div class="detail-stat-r">
      ...
      <div class="detail-stat-readers">
        <div class="detail-stat-readers-avatar"
             v-for="(reader, index) in readers"
             :key="index"
        >
          <image-view :src="reader.avatarUrl" mode="scaleToFill" height="100%" round></image-view>
        </div>
      </div>
    </div>
  </div>
...
<script>
import ImageView from '../base/image-view'
